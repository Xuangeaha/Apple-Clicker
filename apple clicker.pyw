...
def achievement_logic():
    ...
    while whao == 0:
        ...
        if achievement_36_on == 1: achievement_36_get = 1; achievement_get("微型果园", "购买 1 个 果园")
        if achievement_37_on == 1: achievement_37_get = 1; achievement_get("小型果园", "购买 5 个 果园")
        if achievement_38_on == 1: achievement_38_get = 1; achievement_get("中型果园", "购买 10 个 果园")
        if achievement_39_on == 1: achievement_39_get = 1; achievement_get("大型果园", "购买 50 个 果园")
        if achievement_40_on == 1: achievement_40_get = 1; achievement_get("巨型果园", "购买 100 个 果园") 
        
        if achievement_41_on == 1: achievement_41_get = 1; achievement_get("五线城镇", "购买 1 个 水果镇")
        if achievement_42_on == 1: achievement_42_get = 1; achievement_get("四线城镇", "购买 5 个 水果镇")
